        ...
        */
        ...
        a2_button.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                Intent a2intent = new Intent("com.seneca.lab2b.Brooks");
                /*
        ...
        Intent a3intent = new Intent(v.getContext(), ThirdActivity.class);
            ...
            a3intent.putExtra("greeting","Hello Android");
            a3intent.putExtra("number", 9876);

            //bundle
            Bundle message = new Bundle();
            message.putString("my name", "Brooks");
            message.putInt("student id", 68153);
            a3intent.putExtras(message);
    ...
    */
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode == 1){
            ...
            Log.e("lab2", "SOMETHING WENT REALLY WRONG");
        }
        ...
        String toast_text = "Hi" + " " + result + " " + "my name is Android";
