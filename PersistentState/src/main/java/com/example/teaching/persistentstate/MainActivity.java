...
import static com.example.teaching.persistentstate.R.id.Done;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void loadDatabase() {
        ...
        while (hasMoreData) {
            ...
            myList.add( "id: "+ studentID + " " +  "student grade : " +studentGrade);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.select_records_shown:

        setContentView(R.layout.max_rows);
